...
// @ts-ignore
const __VLS_3 = __VLS_asFunctionalComponent(ParamPanel, new ParamPanel({
    ...{ 'onUpdate': {} },
...
__VLS_asFunctionalElement(__VLS_intrinsicElements.button, __VLS_intrinsicElements.button)({
    ...
    disabled: (__VLS_ctx.gen.loading || !__VLS_ctx.prompt.trim() || __VLS_ctx.images.length === 0),
...
// @ts-ignore
const __VLS_10 = __VLS_asFunctionalComponent(ResultGallery, new ResultGallery({
    ...{ 'onPreview': {} },
    ...{ 'onSave': {} },
...
//# sourceMappingURL=ImageToImage.vue.js.map